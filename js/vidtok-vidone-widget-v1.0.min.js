...
(cAccess(),clicked++)});jQuery("div").on("click","#end-arrow",function(a){a.preventDefault();0==clicked&&(cVidone(),clicked++)});jQuery("a[rel='invite-email']").toggle(function(a){a.preventDefault();jQuery(".vidone-widget-invite-email").animate({bottom:"80px"})},function(){jQuery("#vidone-invalid-email").hide();jQuery(".vidone-widget-invite-email").animate({bottom:"-140px"})});jQuery("#vidone-invite-form").on("submit",function(a){a.preventDefault();a=jQuery("#email").val();jQuery.ajax({url:vidoneAjax.ajaxurl,
